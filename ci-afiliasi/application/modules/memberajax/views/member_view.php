	...
	<script type="text/javascript">
		function show_confirm(act,gotoid){
			if(act=="edit"){
				...
				if (r==true){
					window.location="<?php echo base_url();?>memberajax/update_form/"+gotoid;
				}
			}
			else{	
				var r=confirm("Anda ingin hapus data?");
				if (r==true){
					window.location="<?php echo base_url();?>memberajax/delete/"+gotoid;
				}
			}
...
<body>
	...
	<a href="<?php echo base_url();?>memberajax/add_form">Insert New User</a>
</body>
</html>
